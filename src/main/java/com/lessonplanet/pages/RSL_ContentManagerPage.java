...
public class RSL_ContentManagerPage extends LpUiBasePage {
    ...
    public void clickOnConceptLink(WebElement resourceCard, int conceptPosition) {
        clickElement(resourceCard.findElements(By.cssSelector(RESOURCE_CONCEPTS)), conceptPosition);
    }

    public void clickOnStandardLink(WebElement resourceCard, int standardPosition) {
        clickElement(resourceCard.findElements(By.cssSelector(RESOURCE_STANDARDS)), standardPosition);
    }
