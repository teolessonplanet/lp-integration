...
public class ResourcesPage extends LpUiBasePage {
    ...
    private static final String REGULAR_RESOURCE_CARD = "#search-results [class*='search-result-item'] [data-type='Resource']";
    private static final String SHARED_RESOURCE_CARD = "#search-results  [class*='search-result-item'] [data-type='Drive::Document']";
