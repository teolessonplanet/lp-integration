...
public class ReplaceExistingFolderModal extends LpUiBasePage {
    ...
    private static final String PUBLISH_NEW_BUTTON = "#site-specific-metadata-modal [class='modal-footer'] [class*='btn-success confirm']:nth-child(2)";
    private static final String PUBLISH_AND_REPLACE_BUTTON = "#site-specific-metadata-modal [class='modal-footer'] [class*='btn-success confirm']:nth-child(1)";
