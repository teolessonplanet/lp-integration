...
public class CSL_SearchTest extends BaseTest {
    ...
    @Test(description = "Custom SL - Search Page - lessonp-1673:User clicks 'See Collection' footer button", groups = {"csl"})
    ...
    @Test(description = "Custom SL - Search Page -  lessonp-1672:User clicks 'See Full Review' footer button", groups = {"csl"})
    public void testLessonp_1672() {
        rsl_searchTest.initTest(webDriver);
        rsl_searchTest.testGoToResource(TestData.VALID_EMAIL_CSL_HENRY);
    }

    @Test(description = "Custom SL - Search Page -  lessonp-1671:User clicks 'Go to Resource' footer button", groups = {"csl"})
    public void testLessonp_1671() {
        rsl_searchTest.initTest(webDriver);
        rsl_searchTest.testGoToResource(TestData.VALID_EMAIL_CSL_HENRY);
    }

    @Test(description = "Custom SL - Search Page -  lessonp-5567:User clicks 'Open Folder' footer button", groups = {"csl"})
    public void testLessonp_5567() {
        loginAndGetFolderResources(TestData.VALID_EMAIL_CSL_HENRY);
        testOpenFolderButton();
    }

    @Test(description = "Custom SL - Search Page -  lessonp-5568:User clicks 'Folder Details' footer button", groups = {"csl"})
    ...
    @Test(description = "Custom SL - Search Page - lessonp-5274:Cards details - LP resource", groups = {"csl"})
    public void testLessonp_5274() {
        rsl_searchTest.initTest(webDriver);
        rsl_searchTest.testCardDetailsLpResource(TestData.VALID_EMAIL_CSL_HENRY);
    }

    @Test(description = "Custom SL - Search Page - lessonp-5275:Cards details - Collection", groups = {"csl"})
    public void testLessonp_5275() {
        rsl_searchTest.initTest(webDriver);
        rsl_searchTest.testCardDetailsCollection(TestData.VALID_EMAIL_CSL_HENRY);
    }

    @Test(description = "Custom SL - Search Page - lessonp-5664:Cards details - Folder: HMH/McGraw", groups = {"csl"})
