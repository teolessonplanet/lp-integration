...
public class CSL_AdminManager_ContentTest extends BaseTest {
    ...
    @Test(description = "Custom SL - Admin Manager - Content - C2548: Main Page", groups = {"csl"})
    ...
    @Test(description = "Custom SL - Admin Manager - Content - C2550: Cards list", groups = {"csl"})
    public void testC2550() {
        loginPage.performLogin(TestData.VALID_EMAIL_CSL_QA_CUSTOM, TestData.VALID_PASSWORD);
        rsl_adminManagerContentTest.testContentManagerCardsList(TestData.VALID_EMAIL_CSL_QA_CUSTOM);
    }

    @Test(description = "Custom SL - Admin Manager - Content - C2551: Search", groups = {"csl"})
    public void testC2551() {
        loginPage.performLogin(TestData.VALID_EMAIL_CSL_QA_CUSTOM, TestData.VALID_PASSWORD);
        rsl_adminManagerContentTest.testContentManagerSearch();
    }

    @Test(description = "Custom SL - Admin Manager - Content - C2552: Sort By", groups = {"csl"})
    public void testC2552() {
        loginPage.performLogin(TestData.VALID_EMAIL_CSL_QA_CUSTOM, TestData.VALID_PASSWORD);
        rsl_adminManagerContentTest.testContentManagerSortBy();
    }

    @Test(description = "Custom SL - Admin Manager - Content - C2549: Add/Edit/Remove Site Specific Resource", groups = {"csl"})
