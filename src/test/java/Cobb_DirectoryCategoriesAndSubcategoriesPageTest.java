...
public class Cobb_DirectoryCategoriesAndSubcategoriesPageTest extends BaseTest {
    ...
    @Test(description = "Cobb - Directory Page - Categories and subcategories - lessonp-5902: Page UI")
    ...
    @Test(description = "Cobb - Directory Page - Categories and subcategories - lessonp-5903: Resource Tiles")
    ...
    @Test(description = "Cobb - Directory Page - Categories and subcategories - lessonp-5904: RRP modal (Individual resources)")
    ...
    @Test(description = "Cobb - Directory Page - Categories and subcategories - lessonp-5905: RRP modal (Collections)")
    ...
    @Test(description = "Cobb - Directory Page - Categories and subcategories - lessonp-5906: RRP static (Individual resources)")
    ...
    @Test(description = "Cobb - Directory Page - Categories and subcategories - lessonp-5907: RRP static (Collections)")
    ...
    @Test(description = "Cobb - Directory Page - Categories and subcategories - lessonp-5908: Browse by Subject")
    ...
    @Test(description = "Cobb - Directory Page - Categories and subcategories - lessonp-5909: Related Topics")
