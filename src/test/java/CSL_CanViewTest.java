...
public class CSL_CanViewTest extends BaseTest {
    ...
    @Test(description = "Custom SL - Shared With Me - lessonp-5979: Main Page", priority = 11, groups = {"csl"})
    ...
    @Test(description = "Custom SL - Shared With Me - lessonp-5980: Share a folder - Can View Permission", priority = 12, groups = {"csl"})
    ...
    @Test(description = "Custom SL - Shared With Me - lessonp-5981: Drag-and-drop items - Can View Permission", priority = 13, groups = {"csl"})
    ...
    @Test(description = "Custom SL - Shared With Me - lessonp-6012: Verify shared folder - Can View Permission", priority = 14, groups = {"csl"})
