...
public class CSL_CanViewTest extends BaseTest {
    ...
    @Test(description = "CSL - Shared With Me - lessonp-5979: Main Page", priority = 0)
    ...
    @Test(description = "CSL - Shared With Me - lessonp-5980: Share a folder - Can View Permission", priority = 1)
    ...
    @Test(description = "CSL - Shared With Me - lessonp-5981: Drag-and-drop items - Can View Permission", priority = 2)
    ...
    @Test(description = "CSL - Shared With Me - lessonp-6012: Verify shared folder - Can View Permission", priority = 3)
