...
public class RSL_AdminManager_AccountsTest extends BaseTest {
    ...
    @Test(description = "Regular SL - Admin Manager - Accounts - C2397: District Page, Add School, Remove School", groups = {"rsl"})
    ...
    @Test(description = "Regular SL - Admin Manager - Accounts - C2340: Edit District, Search in district", groups = {"rsl"})
    ...
    @Test(description = "Regular SL - Admin Manager - Accounts - C23401: Manage District Admins Page, Add District Admin, Remove District Admin", groups = {"rsl"})
    ...
    @Test(description = "Regular SL - Admin Manager - Accounts - C2398: School Page, Add Teacher, Edit Teacher, Remove Teacher", groups = {"rsl"})
    ...
    @Test(description = "Regular SL - Admin Manager - Accounts - C2399: Edit School, Search in School", groups = {"rsl"})
    ...
    @Test(description = "Regular SL - Admin Manager - Accounts - C2402: Manage School Admins Page, Add School Admin, Remove School Admin", groups = {"rsl"})
    ...
    @Test(description = "Regular SL - Admin Manager - Accounts - C2403: Manage District Page", groups = {"rsl"})
