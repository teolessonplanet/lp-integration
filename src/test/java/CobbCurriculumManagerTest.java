...
public class CobbCurriculumManagerTest extends BaseTest {
    ...
    @Test(description = "Cobb - Curriculum Manager - lessonp-5945: Access Curriculum Manager Page")
    ...
    @Test(description = "Cobb - Curriculum Manager - lessonp-5946: Create Collections")
    public void testLessonp_5946() {
        curriculumManagerPageTest.testMaxLimitOfFoldersCreated(TestData.FOLDER_TYPE[0]);
    }

    @Test(description = "Cobb - Curriculum Manager - lessonp-5947: Upload Resource & My Uploads Folder")
    ...
    @Test(description = "Cobb - Curriculum Manager - lessonp-5948: Favorite Resource & My Favorites Folder")
    ...
    @Test(description = "Cobb - Curriculum Manager - lessonp-5949: Collection: Actions Dropdown")
    ...
    @Test(description = "Cobb - Curriculum Manager - lessonp-5950: Folder Actions Dropdown")
