...
public class Cobb_SearchTest extends BaseTest {
    ...
    @Test(description = "Cobb SL - Search - C2630: User clicks 'See Collection' footer button", groups = {"cobb"})
    public void testC2630() {
        rsl_searchTest.initTest(webDriver);
        rsl_searchTest.testSeeCollection(TestData.VALID_EMAIL_CSL_COBB);
    }

    @Test(description = "Cobb SL - Search - C2631: User clicks 'Go to Resource' footer button", groups = {"cobb"})
    public void testC2631() {
        rsl_searchTest.initTest(webDriver);
        rsl_searchTest.testGoToResource(TestData.VALID_EMAIL_CSL_COBB);
    }

    @Test(description = "Cobb SL - Search - C2632: User clicks 'See Full Review' footer button", groups = {"cobb"})
    public void testC2632() {
        rsl_searchTest.initTest(webDriver);
        rsl_searchTest.testGoToResource(TestData.VALID_EMAIL_CSL_COBB);
    }

    @Test(description = "Cobb SL - Search - C2633: User clicks 'Open Folder' footer button", groups = {"cobb"})
    ...
    @Test(description = "Cobb SL - Search - C2634: User clicks 'Folder Details' footer button", groups = {"cobb"})
    ...
    @Test(description = "Cobb SL - Search - C2635: Cards details - Folder: HMH/McGraw Hill", groups = {"cobb"})
    ...
    @Test(description = "Cobb SL - Search - C2636: Cards details - LP resource", groups = {"cobb"})
    public void testC2636() {
        rsl_searchTest.initTest(webDriver);
        rsl_searchTest.testCardDetailsLpResource(TestData.VALID_EMAIL_CSL_COBB);
    }

    @Test(description = "Cobb SL - Search - C2637: Cards details - Collection", groups = {"cobb"})
    public void testC2637() {
        rsl_searchTest.initTest(webDriver);
        rsl_searchTest.testCardDetailsCollection(TestData.VALID_EMAIL_CSL_COBB);
    }

    @Test(description = "Cobb SL - Search - C2638: Keyword search", groups = {"cobb"})
    ...
    @Test(description = "Cobb SL - Search - C2639: Keyword less search", groups = {"cobb"})
