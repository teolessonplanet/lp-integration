...
public class Cobb_RrpSearchPageTest extends BaseTest {
    ...
    @Test(description = "Cobb - Search Page - RRP Modal - RRP Overview - lessonp-5445:LP Resource Modal Overview")
    ...
    @Test(description = "Cobb - Search Page - RRP Static - RRP Overview - lessonp-5454:LP Resource Static Page Overview")
    public void testlessonp_5454() {
        rsl_rrpSearchPageTest.initTest(webDriver);
        rsl_rrpSearchPageTest.testResourcePageOverview(TestData.VALID_EMAIL_CSL_COBB, false);
    }

    @Test(description = "Cobb - Search Page - RRP Modal - RRP Overview - lessonp-5448:Collection Modal Overview")
    public void testlessonp_5448() {
        rsl_rrpSearchPageTest.initTest(webDriver);
        rsl_rrpSearchPageTest.testCollectionPageOverview(TestData.VALID_EMAIL_CSL_COBB, true);
    }

    @Test(description = "Cobb - Search Page - RRP Static - RRP Overview - lessonp-5457:Collection Static Page Overview")
    public void testlessonp_5457() {
        rsl_rrpSearchPageTest.initTest(webDriver);
        rsl_rrpSearchPageTest.testCollectionPageOverview(TestData.VALID_EMAIL_CSL_COBB, false);
    }

    @Test(description = "Cobb - Search Page - RRP Modal - RRP Overview - lessonp-5446:Site Specific Resource Modal Overview")
    ...
    @Test(description = "Cobb - Search Page - RRP Static - RRP Overview - lessonp-5455:Site Specific Resource Static Page Overview")
    ...
    @Test(description = "Cobb - Search Page - RRP Modal - RRP Overview - lessonp-5447:Proprietary Resource Modal Overview")
    public void testlessonp_5447() {
        csl_rrpSearchPageTest.initTest(webDriver);
        csl_rrpSearchPageTest.testProprietaryResource(true, TestData.VALID_EMAIL_CSL_COBB);
    }

    @Test(description = "Cobb - Search Page - RRP Static - RRP Overview - lessonp-5456:Proprietary Resource Static Page Overview")
    public void testlessonp_5456() {
        csl_rrpSearchPageTest.initTest(webDriver);
        csl_rrpSearchPageTest.testProprietaryResource(false, TestData.VALID_EMAIL_CSL_COBB);
    }

    @Test(description = "Cobb - Search Page - RRP Modal - RRP Overview - lessonp-5942:Folder (HMH/McGraw) Modal Overview")
    public void testlessonp_5942() {
        csl_rrpSearchPageTest.initTest(webDriver);
        csl_rrpSearchPageTest.testFolderHmhMcGraw(true, TestData.VALID_EMAIL_CSL_COBB);
    }

    @Test(description = "Cobb - Search Page - RRP Static - RRP Overview - lessonp-5943:Folder (HMH/McGraw) Static Overview")
