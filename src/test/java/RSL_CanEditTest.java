...
public class RSL_CanEditTest extends BaseTest {
    ...
    @Test(description = "Regular SL - Shared With Me - lessonp-5973:Share a folder - Can Edit Permission", priority = 1, groups = {"rsl"})
    ...
    @Test(description = "Regular SL - Shared With Me - lessonp-6116:Drag-and-drop items - Can Edit Permission", priority = 2, groups = {"rsl"})
    ...
    @Test(description = "Regular SL - Shared With Me - lessonp-6117:Verify shared folder - Can Edit Permission", priority = 3, groups = {"rsl"})
