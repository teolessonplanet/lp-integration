...
public class CSL_CanEditTest extends BaseTest {
    ...
    @Test(description = "Custom SL - Shared With Me - lessonp-5982: Share a folder - Can View Permission", priority = 1, groups = {"csl"})
    ...
    @Test(description = "Custom SL - Shared With Me - lessonp-5991: Drag-and-drop items - Can View Permission", priority = 2, groups = {"csl"})
    ...
    @Test(description = "Custom SL - Shared With Me - lessonp-5983: Verify shared folder - Can View Permission", priority = 3, groups = {"csl"})
