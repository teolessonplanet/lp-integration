...
public class User_BrowseResourceDirectory_SubjectsTest extends BaseTest {
    ...
    @Test(description = "Visitor - Browse Resource Directory - Subjects - C2059: Page UI", groups = {"visitor"})
    public void testC2059() {
        testPageUi();
    }

    @Test(description = "Free member - Browse Resource Directory - Subjects- C2174: Page UI", groups = {"freemium"})
    public void testC2174() {
        stepTwoPage.createNewAccount(TestData.PLAN_FREEMIUM);
        testPageUi();
    }

    @Test(description = "Active user - Browse Resource Directory - Subjects- C2289: Page UI", groups = {"activeUser"})
    public void testC2289() {
        stepTwoPage.createNewAccount(TestData.PLAN_PRO);
        testPageUi();
    }

    @Test(description = "Visitor - Browse Resource Directory - Subjects - C2060: Resource Tiles", groups = {"visitor"})
    ...
    @Test(description = "Active user - Browse Resource Directory - Subjects - C2290: Resource Tiles", groups = {"activeUser"})
    ...
    @Test(description = "Visitor - Browse Resource Directory - Subjects - C2061: Browse by Subject", groups = {"visitor"})
    public void testC2061() {
        testBrowseBySubject(TestData.PLAN_VISITOR);
    }

    @Test(description = "Free member - Browse Resource Directory - Subjects - C2175: Browse by Subject", groups = {"freemium"})
    public void testC2175() {
        stepTwoPage.createNewAccount(TestData.PLAN_FREEMIUM);
        testBrowseBySubject(TestData.PLAN_FREEMIUM);
    }

    @Test(description = "Active user - Browse Resource Directory - Subjects - C2291: Browse by Subject", groups = {"activeUser"})
    public void testC2291() {
        stepTwoPage.createNewAccount(TestData.PLAN_PRO);
        testBrowseBySubject(TestData.PLAN_PRO);
    }

    @Test(description = "Visitor - Browse Resource Directory - Subjects - C2062: Start your 10 day free trial", groups = {"visitor"})
    public void testC2062() {
        browseBySubjectPage.loadPage(TestData.HEALTH_PAGE_PATH);
        testStartYourTenDayFreeTrial(TestData.PLAN_VISITOR);
    }

    @Test(description = "Free member - Browse Resource Directory - Subjects - C2176: Start your 10 day free trial", groups = {"freemium"})
    ...
    @Test(description = "Visitor - Browse Resource Directory - Subjects - C2063: Related Topics", groups = {"visitor"})
    public void testC2063() {
        testRelatedTopics();
    }

    @Test(description = "Free member - Browse Resource Directory - Subjects - C2177: Related Topics", groups = {"freemium"})
    public void testC2177() {
        stepTwoPage.createNewAccount(TestData.PLAN_FREEMIUM);
        testRelatedTopics();
    }

    @Test(description = "Active user - Browse Resource Directory - Subjects - C2292: Related Topics", groups = {"activeUser"})
    public void testC2292() {
        stepTwoPage.createNewAccount(TestData.PLAN_PRO);
        testRelatedTopics();
    }

    @Test(description = "Visitor - Browse Resource Directory - Subjects - C2064: What members say", groups = {"visitor"})
    public void testC2064() {
        browseBySubjectPage.loadPage(TestData.HEALTH_PAGE_PATH);
        testTestimonials(TestData.PLAN_VISITOR);
    }

    @Test(description = "Free member - Browse Resource Directory - Subjects - C2178: What members say", groups = {"freemium"})
    ...
    @Test(description = "Active user - Browse Resource Directory - Subjects - C2293: What members say", groups = {"activeUser"})
